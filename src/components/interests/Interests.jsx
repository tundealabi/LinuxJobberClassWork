...
const Interests = () => {
  ...
  const [ranges, setRanges] = useState([
    { title: 'Cyber Security', value: 0 },
    { title: 'Project Manager', value: 0 },
    { title: 'Developer', value: 0 },
    { title: 'Product Manager', value: 0 },
    { title: 'DevOps', value: 0 },
    { title: 'Marketer', value: 0 },
    { title: 'Designer', value: 0 },
    { title: 'Writer', value: 0 },
  ]);
  ...
  useEffect(() => {
    ...
    ranges.forEach((range) => {
      uniques.add(range.value);
    });
    setIserror(uniques.size != ranges.length);
  }, [ranges]);
    ...
    <div className="interest">
      ...
      <p
        style={{
          fontSize: 18,
          fontStyle: 'italic',
          color: isError ? 'var(--red)' : 'var(--sliderText)',
          marginTop: 10,
        }}
      >
